...
while($row = mysqli_fetch_assoc($check)){
	...
	if(isset($_POST['submit'])){
		...
		if($v_title == ""){
			...
			mysqli_query($conn1,"UPDATE featured SET video_title='$v_title',video_description='$v_desc', video_keywords='$v_keywords', privacy='$v_privacy' WHERE video_id='$videoid'");
			die("Success");
		}
...
<form action='editfeatured_video.php?videoid=<?php echo $videoid;?>' method='POST' enctype='multipart/form-data'>
