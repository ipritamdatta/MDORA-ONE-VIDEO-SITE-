	...
	if(isset($_FILES['video'])){
		...
		if(($_FILES['video']['type']=='video/mp4'))
		{
			...
			if(file_exists('data/users/videos/' . $random_directory. ''.$_FILES['video']['name']))
			{
				...
				$check_md5 = mysqli_query($conn1,"SELECT file_md5 FROM videos WHERE file_md5='$md5_file'");
				...
				$insert = mysqli_query($conn1,"INSERT INTO videos VALUES ('','$title','$desc','$keywords','$user','$privacy','$date','0','$video_id','','$filename','images/thumbnail.png','no')");
				mysqli_query($conn1,"UPDATE videos SET file_md5='$md5_file' WHERE video_id='$video_id'");
